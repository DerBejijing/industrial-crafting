...
public enum Weapon {
    ...
    DESERT_EAGLE("mgs_catalog:assult_rifles/desert_eagle", 7),
    GLOCK_17("mgs_catalog:assult_rifles/glock17", 17),
    GLOCK_18("mgs_catalog:assult_rifles/glock18", 19),
    M9("mgs_catalog:assult_rifles/m9", 15),
    PM("mgs_catalog:assult_rifles/pm", 8),
    VZ61("mgs_catalog:assult_rifles/vz61", 20),
