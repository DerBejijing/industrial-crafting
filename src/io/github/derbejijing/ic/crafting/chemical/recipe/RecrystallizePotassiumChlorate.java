...
public class RecrystallizePotassiumChlorate extends ChemicalRecipe {

    public RecrystallizePotassiumChlorate(MultiblockMachine master) {
    ...
    public void add_outputs() {
        this.add_output(ChemicalItem.POTASSIUM_CHLORATE, 1, ChemicalPurity.INDUSTRIAL_GRADE);
    }
}
